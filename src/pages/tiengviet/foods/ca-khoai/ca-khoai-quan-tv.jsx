...
const CAKHOAIQUANTV = () => {
    ...
    return (
        <div className="container pb-20">
            ...
            <FoodContent title="1.Quán Trinh Lẩu Cá Khoai">
                <div className="flex flex-col gap-4">
                    ...
                    <div>
                        <div>
                            ...
                            <span>Trương Văn Kỉnh, Phường 1, Thành phố Trà Vinh, tỉnh Trà Vinh.</span>
                        </div>
                        <div className="mt-4">
            ...
            <FoodContent title="2.Quán 67">
                <div className="flex flex-col gap-4">
                    <div>
                        <div>
                            <span className="font-semibold">Địa chỉ: </span>
                            <span>Phường 1, Thành phố Trà Vinh, tỉnh Trà Vinh.</span>
                        </div>
                        <div className="mt-4">
