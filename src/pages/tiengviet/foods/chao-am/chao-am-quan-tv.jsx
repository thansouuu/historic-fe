...
const CHAOAMQUANTV = () => {
    ...
    return (
        <div className="container pb-20">
            ...
            <FoodContent title="1.Quán Vân Anh">
                <div className="flex flex-col gap-4">
                    ...
                    <div>
                        <div>
                            ...
                            <span>Thạch Thị Thanh, Khóm 6, Phường 8, Thành phố Trà Vinh,Tỉnh Trà Vinh.</span>
                        </div>
                        <div className="mt-4">
            ...
            <FoodContent title="2.Quán Cháo Cá Lóc">
                <div className="flex flex-col gap-4">
                    ...
                    <div>
                        <div>
                            <span className="font-semibold">Địa chỉ: </span>
                            <span>Ấp Trì Phong, Xã Hòa Lợi, Huyện Châu Thành, Tỉnh Trà Vinh.</span>
                        </div>
                    ...
                    <div>
                        ...
                        <iframe
                            ...
                            src="https://www.youtube.com/embed/Tb2Kbt_Fpzw?list=PLO4xYQBA1oxU8Wh7CFDOoIq3broDVrOX3"
