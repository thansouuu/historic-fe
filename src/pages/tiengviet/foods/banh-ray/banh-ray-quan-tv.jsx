...
const BANHRAYQUANTV = () => {
    ...
    return (
        <div className="container pb-20">
            ...
            <FoodContent title="1.Bánh Rây Trường Minh Trí">
                <div className="flex flex-col gap-4">
                    ...
                    <div>
                        <div>
                            ...
                            <span>Trần Phú, Phường 7, Thành phố Trà Vinh, Tỉnh Trà Vinh (Đối diện quán Cà phê Nguyên 2).</span>
                        </div>
                        <div className="mt-4">
                    ...
                    <div>
                        ...
                        <iframe
                            ...
                            src="https://www.youtube.com/embed/mW0oZOePe-o?list=PLO4xYQBA1oxVtcQx91K4UbaY5yQiwcARE"
            ...
            <FoodContent title="2.Khu Di Tích Ao Bà Om">
                <div className="flex flex-col gap-4">
                    ...
                    <div>
                        <div>
                            <span className="font-semibold">Địa chỉ: </span>
                            <span>Phường 8, Thành phố Trà Vinh, Tỉnh Trà Vinh.</span>
                        </div>
                        <div className="mt-4">
