        ...
        <div className="container pb-20">
                                    ...
                                    <li>
                                        ...
                                        <div className='flex flex-col gap-4'>
                                            <div className='flex  flex-col gap-4 md:border-none border-t pt-4'>
                                                <span className=''>Đặc biệt, đối với trò chơi này, chỉ cần bạn nằm trong top 10, bạn sẽ nhận được bộ ảnh đặc quyền riêng biệt:</span>
            ...
            <div className="mb-4">
                ...
                <div className="rounded-2xl shadow overflow-hidden">
                    ...
                    src="https://wordwall.net/embed/902fcaa4e7c4429392d16d9112a9d6fd?themeId=21&templateId=69&fontStackId=0"
